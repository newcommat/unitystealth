...
public class LiftDoorsTracking : MonoBehaviour {
    ...
    private float leftClosedXPos;
    private float rightClosedXPos;
    ...
    void Awake()
    {
        ...
        leftClosedXPos = leftInnerDoor.position.x;
        rightClosedXPos = rightInnerDoor.position.x;
    }
    ...
    {
        MoveDoors(leftClosedXPos, rightClosedXPos);
    }
}
